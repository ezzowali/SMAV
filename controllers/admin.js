...
<img class="adapt-img esdev-stretch-width esdev-banner-rendered" src="https://i.pinimg.com/originals/6c/57/cd/6c57cdab37a434ebbfd133893e8c5c7c.gif" alt title width="70%">
</a>
</p>
      ...
      var userEditing = await Users.findOne({email:email}).select("accept email").then(data=>{
        ...
        if (data.email==req.body.email ) {
          ...
          Users.updateOne({email:data.email},{accept:accepting}).then(update=>{
            ...
            <p style="color: 000000;">
            نقدر لك رغبتك ومبادرتك للمشاركة في برنامجنا 
            ...
            <p class="esd-block-banner" style="position: relative; color: black;" align="center" esdev-config="h2"><a target="_blank">
            <img class="adapt-img esdev-stretch-width esdev-banner-rendered" src="https://www.animatedimages.org/data/media/1551/animated-sorry-and-apology-image-0020.gif" alt title width="70%">
            </a>
            </p>
